...
<body>
    <div class="container-fluid ">
        <div class='row my-4 ml-5'>
            <a class="" href="/">
            <img class="d-none d-lg-block" src="/images/logo.png" alt="logo">  
                ...
                <div class="row">
                    <div class="col-7 offset-2 my-4">
                        <div class="d-flex" style="flex-direction: column;height: 100%;justify-content: space-between;">
                            <form action="">
                                <div id="step-1">
                                    <h1 class="font-weight-bold mb-5">Are you representing a retail brand, boutique or are an independant stylist?</h1>
                                ...
                                <div id="step-2" class="mt-5" style="display: none;">
                                    <h1 class="font-weight-bold mb-5">Start your new side job <br>-home office or freelance - <br>and earn money styling customers.</h1>
                                    <div class="">
                                ...
                                <div id="step-3" class = "mt-5" style="display: none;">
                                    ...
                                    <div class="">
                                        ...
                                        <div id="upload_resume" class="dropzone">
                                        </div>
                                    </div>
                                    <div class = "mt-4">
                                        <span class ='font-weight-bold question'>
                                ...
                                <div id="step-4" class = "m-auto col-10" style="display: none;">
                                    <h1 class="font-weight-bold mb-5 question text-center congrate">Congratulations!</h1>
