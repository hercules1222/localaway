...
<!-- 
                    <div class="item item-show row ">
                        <div class="col-4 text-center">
                            ...
                            <button class="btn-circle prev-button my-3 item-button" data-key="13" id="start-button" type="button">Start</button>
            ...
            <div class="navigation-bar p-5">
                <button class="btn btn-primary prev-button">Prev</button>
